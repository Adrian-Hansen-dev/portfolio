...
export default function AboutOverview() {
  ...
  return (
    <section
      id="about"
      className="flex min-h-screen w-full scroll-mt-20 flex-col justify-center p-4 md:max-w-5xl"
    >
      {isLoading ? (
        ...
        <>
          ...
          <div className="mt-1 flex gap-1">
            ...
            <Button
              onClick={() => (location.href = data.linkedInLink)}
              variant="ghost"
              size="icon"
            >
              <svg
